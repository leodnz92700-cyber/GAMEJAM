...
- **trap.py** : Les pièges. Un danger à éviter mais aussi une opportunité
  ...
  la largeur du couloir. Le **squelette archer** vit ici aussi : un tireur
  immobile et increvable, posé dans une grande salle, qui balaie la pièce de
  flèches à une cadence que l'on ne franchit pas à l'aveugle. Il ne s'arrête
  jamais, même après avoir tué : c'est le CADAVRE laissé sur la trajectoire qui
  arrête les flèches, et c'est la seule vraie réponse.
